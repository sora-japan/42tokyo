...
| # | Chapter | Page |
|---|---------|------|
| I | [Goals](#chapter-i--goals) | 2 |
| II | [Common Instructions](#chapter-ii--common-instructions) | 3 |
| III | [AI Instructions](#chapter-iii--ai-instructions) | 5 |
| IV | [Mandatory part](#chapter-iv--mandatory-part) | 7 |
| V | [Readme Requirements](#chapter-v--readme-requirements) | 9 |
| VI | [Bonus part](#chapter-vi--bonus-part) | 10 |
| VII | [Submission and peer-evaluation](#chapter-vii--submission-and-peer-evaluation) | 11 |
...
> ℹ️ Try to read as little as possible each time `get_next_line()` is called. If you encounter a new line, you have to return the current line.
